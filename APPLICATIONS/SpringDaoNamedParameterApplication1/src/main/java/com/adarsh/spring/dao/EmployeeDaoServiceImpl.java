...
public class EmployeeDaoServiceImpl implements EmployeeDaoService {
	...
	public List<Map<String, Object>> getEmployeeDataList() {
		...
		return this.namedJdbcTemplate.queryForList(sqlQuery,new HashMap<String,Object>());
	}
	...
	public Map<String, Object> getEmployeeDataMap(Integer employeeNumber) {
	   ...
	   return this.namedJdbcTemplate.queryForMap(sqlQuery, namedParameters);
	}
	...
	public Employee getEmployeeData(Integer employeeNumber) {
		...
		return (Employee) namedJdbcTemplate.queryForObject(sqlQuery, namedParameters
			 , new RowMapper() {
