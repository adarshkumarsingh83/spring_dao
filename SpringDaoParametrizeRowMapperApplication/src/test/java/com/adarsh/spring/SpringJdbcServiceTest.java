...
public class SpringJdbcServiceTest extends TestAnnotatedContext {
    ...
    public void getEmployeeMap() {
        final Map<String, Object> employeeMap =  employeeDaoService.getEmployeeDataMap(new Integer(1));
    ...
    public void getEmployeeInsertAndUpdate() {
        ...
        Integer updateStatus = employeeDaoService.updateEmployee(new Integer(10), "employeeName", "employee@Email");
